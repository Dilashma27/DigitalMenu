...
class ProductRepoImpl: ProductRepo {
    ...
    val ref: DatabaseReference = database.getReference("Products") //Table

    private val cloudinary = Cloudinary(
        mapOf(
            "cloud_name" to "dsndkbm3n",
            "api_key" to "184828116497851",
            "api_secret" to "s2JVO6Cat8IIc19nyUyIQwZ7qfM"
        )
    )
